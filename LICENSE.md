...
We hereby grant you the rights set forth in the Apache License, Version 2.0
(the "Apache License") with respect to the Software, subject to the terms of the
Apache License. A copy of the Apache License is available at
